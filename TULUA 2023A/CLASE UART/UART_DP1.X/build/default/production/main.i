...
# 31 "./mcc_generated_files/eusart.h"
typedef union {
    struct {
        unsigned perr : 1;
        unsigned ferr : 1;
...
# 66 "./mcc_generated_files/eusart.h"
void EUSART_Initialize(void);
# 114 "./mcc_generated_files/eusart.h"
_Bool EUSART_is_tx_ready(void);
# 162 "./mcc_generated_files/eusart.h"
_Bool EUSART_is_rx_ready(void);
# 209 "./mcc_generated_files/eusart.h"
_Bool EUSART_is_tx_done(void);
# 257 "./mcc_generated_files/eusart.h"
eusart_status_t EUSART_get_last_status(void);
# 277 "./mcc_generated_files/eusart.h"
uint8_t EUSART_Read(void);
# 297 "./mcc_generated_files/eusart.h"
void EUSART_Write(uint8_t txData);
# 317 "./mcc_generated_files/eusart.h"
...
void main(void)
{
    ...
    oldValueA = PORTBbits.RB0;
    oldValueB = PORTBbits.RB1;
    oldValueC = PORTBbits.RB2;


    while (1)
    {
        statusBTNA = PORTBbits.RB0;
        statusBTNB = PORTBbits.RB1;
        statusBTNC = PORTBbits.RB2;
