...
void _write_nibble(uint8_t nibble){
    if( (nibble & 0x01) == 0) LATD &= ~(1<<4); else LATD |= (1<<4);
    if( (nibble & 0x02) == 0) LATD &= ~(1<<5); else LATD |= (1<<5);
    if( (nibble & 0x04) == 0) LATD &= ~(1<<6); else LATD |= (1<<6);
    if( (nibble & 0x08) == 0) LATD &= ~(1<<7); else LATD |= (1<<7);
...
void _send_byte(uint8_t value, uint8_t mode){
    ...
    switch(mode){
        case 0: LATD &= ~(1<<0); break;
        case 1: LATD |= (1<<0); break;
    }
...
void lcd_scroll_left(void){
    lcd_command(0x10 | 0x00 | 0x08);
    _delay((unsigned long)((37)*(8000000UL/4000000.0)));
}
void lcd_scroll_right(void){
    lcd_command(0x10 | 0x04 | 0x08 );
    _delay((unsigned long)((37)*(8000000UL/4000000.0)));
}
