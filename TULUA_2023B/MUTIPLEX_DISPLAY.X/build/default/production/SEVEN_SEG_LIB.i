...
void decoAC(char num){
     LATBbits.LATB6 = (deco_ac_values[num]&1) != 0 ? 1:0;
     LATBbits.LATB0 = (deco_ac_values[num]&2) != 0 ? 1:0;
     LATBbits.LATB2 = (deco_ac_values[num]&4) != 0 ? 1:0;
     LATBbits.LATB3 = (deco_ac_values[num]&8) != 0 ? 1:0;
     LATBbits.LATB4 = (deco_ac_values[num]&16) != 0 ? 1:0;
     LATBbits.LATB5 = (deco_ac_values[num]&32) != 0 ? 1:0;
     LATBbits.LATB1 = (deco_ac_values[num]&64) != 0 ? 1:0;
}
