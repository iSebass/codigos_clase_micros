...
void _write_nibble(uint8_t nibble){
    if( (nibble & 0x01) == 0) PORTD &= ~(1<<4); else PORTD |= (1<<4);
    if( (nibble & 0x02) == 0) PORTD &= ~(1<<5); else PORTD |= (1<<5);
    if( (nibble & 0x04) == 0) PORTD &= ~(1<<6); else PORTD |= (1<<6);
    if( (nibble & 0x08) == 0) PORTD &= ~(1<<7); else PORTD |= (1<<7);
